...
class stret02 extends StatefulWidget {
  const stret02({super.key});

  @override
  State<stret02> createState() => _stret02State();
}

class _stret02State extends State<stret02> {
