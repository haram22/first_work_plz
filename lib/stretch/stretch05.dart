...
import 'stretch11_12.dart';

class stret05 extends StatefulWidget {
  const stret05({super.key});

  @override
  State<stret05> createState() => _stret05State();
}

class _stret05State extends State<stret05> {
          ...
          Padding(
              ...
              child: Stack(
                children: [
                      ...
                      child: CircularCountDownTimer(
                        ...
                        onComplete: () {
                          Navigator.push(
                            context,
                            PageRouteBuilder(
                              pageBuilder: (_, __, ___) => stretch11(),
                              transitionDuration: Duration(seconds: 0),
                              transitionsBuilder: (_, a, __, c) =>
                                  FadeTransition(opacity: a, child: c),
                            ),
                  ...
                  //// hide button ////
                  Padding(
                      padding: const EdgeInsets.only(top: 185.0, left: 70),
