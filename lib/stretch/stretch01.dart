...
class stret01 extends StatefulWidget {
  const stret01({super.key});

  @override
  State<stret01> createState() => _stret01State();
}

class _stret01State extends State<stret01> {
          ...
          Padding(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  ...
                  //     MaterialPageRoute(builder: (context) => stret02()));
                },
                icon: Icon(
